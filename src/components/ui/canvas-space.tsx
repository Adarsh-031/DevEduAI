  ...
  return (
    ...
    >
      <div
        ...
        className="w-full flex-1 overflow-y-auto [&::-webkit-scrollbar]:w-1.5 [&::-webkit-scrollbar-thumb]:bg-gray-300"
      >
        <div className="p-8 h-full flex flex-col">
          {renderedComponent ? (
            <div className="space-y-6 pb-8 flex flex-col items-center justify-center w-full">
              <div
                className={cn(
